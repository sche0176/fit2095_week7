...
mongoose.connect('mongodb://localhost:27017/MovieLibrary', function(req, res) {
    if (err) {
...
app.delete('/deleteactorandmovies/:id', actors.deleteActorAndMovies);
...
app.get('/deletemovies/:year1/:year2', movies.deleteMoviesRangeYears);